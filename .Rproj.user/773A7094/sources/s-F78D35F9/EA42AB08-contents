...
#' 
#' \code{excess_att} Measure excess attenuation in signals referenced in a extended selection table.
#' @usage excess_att(X, mar, parallel = 1, pb = TRUE, method = 1, eq.dur = FALSE,
#' noise.ref = "before", bp = NULL, wl = 10, output = "est")
...
excess_att <- function(X, mar, parallel = 1, pb = TRUE, method = 1, eq.dur = FALSE,
                      noise.ref = "before", bp = NULL, wl = 10, output = "est"){
  ...
  rms_FUN <- function(y, mar, bp, wl, noise.ref){
