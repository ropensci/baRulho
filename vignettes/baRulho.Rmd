...
source("~/Dropbox/R_package_testing/baRulho/R/prep_X_bRlo_int.R")
...
# run blur ratio
br <- blur_ratio(playback_est, method = 1, img = FALSE)
...
sbr <- blur_ratio(playback_est, method = 1, img = TRUE, dest.path = tempdir())
...
envs <- blur_ratio(X = playback_est, output = "list", ssmooth = 300, img = FALSE)$envelopes
...
envs <- blur_ratio(X = playback_est, output = "list", ssmooth = 1000, img = FALSE)$envelopes
...
# run Spectrum blur ratio
sbr <- spectrum_blur_ratio(playback_est, method = 1)
...
ea <- excess_attenuation(playback_est, method = 1)
...
# run  envelope correlation
ec <- envelope_correlation(playback_est, method = 1)
...
sc <- spectrum_correlation(playback_est, method = 1)
...
# run spcc
spd <- spcc_distortion(X = playback_est, method = 1, wl = 512)
