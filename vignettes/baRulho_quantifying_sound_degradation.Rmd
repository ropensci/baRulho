...
alg.tests <- align_test_files(X =  master.sf, Y = pks, path = td, by.song = "sound.files")
...
spectrograms(alg.est, by.song = "sound.files", xl = 3, collevels = seq(-60, 0, 5), dest.path = td, osci = TRUE)
